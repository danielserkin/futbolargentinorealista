...
- La marca ya publica en Nostr y Telegraph. Falta acceso a las métricas de Cloudflare/Adsterra para atribuir visitas e ingresos. No hay visitas nuevas verificadas ni una cifra de tokens facturados disponible.
...
- Difusión externa publicada: identidad de marca en Nostr, hilo de cinco mensajes verificado y artículo en Telegraph. URLs y comprobantes en `docs/difusion/publicaciones-2026-09-08.json`. Las credenciales locales permanecen excluidas de Git. No hay visitas atribuibles verificadas.
